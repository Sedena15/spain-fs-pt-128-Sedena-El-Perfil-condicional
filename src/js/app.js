...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
    ...
    variables.lastName == null ? "apellido" : variables.lastName
          ...
          <h2>${variables.role == null ? "Pon tu role" : variables.role}</h2>
          <h3>${variables.city == null ? "Pon tu ciudad" : variables.city}, ${
    variables.country == null ? "Pon tu país" : variables.country
  }</h3>
